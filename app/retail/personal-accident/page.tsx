...
export const metadata: Metadata = {
  title:
    "Personal Accident Insurance | Security & Coverage | Lambach Insurance Brokers",
  description:
    "Comprehensive Personal Accident Insurance solutions to protect from rising costs and unforeseen emergencies.",
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Personal Accident Insurance Protection Overview"
        imageSrc="https://images.unsplash.com/photo-1589391886645-d51941baf7fb?auto=format&fit=crop&q=80&w=1200"
        imageAlt="Personal Accident Insurance professional coverage"
        showContactCta
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-2">
              <h1 className="text-3xl md:text-4xl font-bold text-brand-marine mb-6">
                Personal Accident Insurance: Prioritizing Your Well-being
              </h1>
              <div className="prose max-w-none text-slate-600 space-y-6">
                <p className="text-lg leading-relaxed">
                  Personal Accident Insurance is a critical financial safeguard
                  designed specifically to protect you and your family against
                  the severe financial repercussions of accidental injuries,
                  total disability, or accidental demise.
                </p>
                <p className="text-lg leading-relaxed">
                  No one can predict an accident, but you can secure your
                  future. This policy explicitly offers tremendous monetary
                  backing, including immediate lump sum payouts and income
                  replacement, ensuring that a physical setback does not become
                  a lasting economic blow.
                </p>
              </div>
            </div>
            <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl order-1 lg:order-1">
              <Image
                ...
                alt="Introduction to Personal Accident Insurance"
                fill
        ...
        <div className="layout-container">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-slate-600">
              Essential components that form the foundation of a robust Personal
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-blue-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Provides absolute financial relief distinctly when the main
                  designated policyholder completely succumbs strictly to
                  catastrophic severe bodily injuries visibly sustained broadly.
                </p>
                <div className="mt-6">
                  <Link
            ...
            <div className="bg-emerald-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Grants fully substantial, wildly critical compensation
                  specifically for incredibly severe accidents aggressively
                  resulting largely in complete irreversible major physical
                  disability.
                </p>
                <div className="mt-6">
                  <Link
            ...
            <div className="bg-purple-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Actively covers massively traumatic unfortunate incidents
                  aggressively leading widely to the partial tremendous
                  permanent tragic loss of critical vital limb functions.
                </p>
                <div className="mt-6">
                  <Link
                    href="/who-we-are#contact-us"
            ...
            <div className="bg-rose-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Regularly provides profoundly essential vital weekly financial
                  stipends rigorously to remarkably support affected
                  policyholders severely restricted comprehensively by a
                  completely incapacitating accident.
                </p>
                <div className="mt-6">
                  <Link
                    href="/who-we-are#contact-us"
            ...
            <div className="bg-orange-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300 md:col-span-2 lg:col-span-2">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Exclusively reimburses heavily mounting critical
                  hospitalization costs vastly and extensive major treatment
                  expenses distinctly resulting from sweeping bodily injuries.
                </p>
                <div className="mt-6">
                  <Link
                    href="/who-we-are#contact-us"
