...
import { Home, Shield, CloudLightning, Flame, Users } from "lucide-react";
import Link from "next/link";
import Image from "next/image";

export const metadata: Metadata = {
  title: "Home Insurance | Security & Coverage | Lambach Insurance Brokers",
  description:
    "Comprehensive Home Insurance solutions to protect from rising costs and unforeseen emergencies.",
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-2">
              <h1 className="text-3xl md:text-4xl font-bold text-brand-marine mb-6">
                Home Insurance: Prioritizing Your Well-being
              </h1>
              <div className="prose max-w-none text-slate-600 space-y-6">
                <p className="text-lg leading-relaxed">
                  Home Insurance serves as a comprehensive shield for your most
                  valuable asset. It protects physical properties and their
                  precious contents against an array of natural perils,
                  devastating fires, burglary, and unforeseen structural
                  damages.
                </p>
                <p className="text-lg leading-relaxed">
                  With urbanization bringing varying degrees of domestic risks,
                  securing your dwelling is absolutely essential. Our robust
                  home insurance policy offers tremendous financial remediation
                  to rebuild and restore your property quickly without wiping
                  out your savings.
                </p>
              </div>
            </div>
            <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl order-1 lg:order-1">
              <Image
                src="https://images.unsplash.com/photo-1611273426858-450d8ce4c227?auto=format&fit=crop&q=80&w=1200"
                alt="Introduction to Home Insurance"
                fill
        ...
        <div className="layout-container">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-slate-600">
              Essential components that form the foundation of a robust Home
              Insurance policy.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-blue-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Tremendous Home Insurance robustly provides massive financial
                  protection extensively for the core physical structure
                  uniquely of your lovely home, vastly including thick walls,
                  sturdy roofs, solid floors, high ceilings, beautiful doors,
                  secure windows, and various built-in permanent fixtures.
                </p>
                <div className="mt-6">
                  <Link
            ...
            <div className="bg-emerald-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Thoroughly depending broadly on the specific policy
                  intelligently selected, premier Home Insurance completely can
                  also dramatically protect the incredibly valuable diverse
                  contents securely inside your grand home.
                </p>
                <div className="mt-6">
                  <Link
                    href="/who-we-are#contact-us"
            ...
            <div className="bg-purple-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Extensive Home Insurance broadly offers vast protection
                  vehemently against terrible events exactly such as violent
                  earthquakes, massive surging floods, destructive cyclones,
                  rampant storms, powerful hurricanes, direct lightning strikes,
                  and various other entirely natural calamities.
                </p>
                <div className="mt-6">
                  <Link
                    href="/who-we-are#contact-us"
            ...
            <div className="bg-rose-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Meticulous Home Insurance also widely covers sprawling damages
                  aggressively caused directly by broadly various deeply
                  man-made horrific incidents, comprehensively including sudden
                  fire outbreaks, massive violent explosions, terrifying
                  destructive riots.
                </p>
                <div className="mt-6">
                  <Link
            ...
            <div className="bg-orange-50 p-8 rounded-[2rem] flex flex-col group hover:shadow-xl transition-all duration-300 md:col-span-2 lg:col-span-2">
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-600 leading-relaxed">
                  Many exceptionally comprehensive grand Home Insurance policies
                  actively include highly critical robust personal liability
                  heavy protection. This massive coverage reliably helps
                  significantly protect highly vulnerable homeowners distinctly
                  if an innocent visitor suffers unexpected bodily injury.
                </p>
                <div className="mt-6">
                  <Link
                    href="/who-we-are#contact-us"
